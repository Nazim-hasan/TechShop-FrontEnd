...
const ManageEmployee = () => {
     ...
     const showDetails = (id) => {
          ...
          fetch(`https://localhost:44352/api/employee/get/${id}`)
          .then(res=>res.json())
  ...
  const hideModal = () => {
    ...
    reset();
     ...
     const handleDelete=(id)=>{
          ...
          if(proceed){
               fetch(`https://localhost:44352/api/Employee/delete/${id}`,{
                   method: 'POST'
               })
               .then(res => res.json())
               .then(data=>{
     ...
     const onSubmitEdit = data => {
          ...
          const url=`https://localhost:44352/api/Employee/edit`;
                                        fetch(url, {
                                             method: 'POST',
                                             headers: {
          ...
          // axios.post('https://localhost:44352/api/Employee/edit',data)
          // .then(res => {
          //     console.log(res);
     ...
     const [isOpenAddEmp, setIsOpenAddEmp] = React.useState(false);
                                   ...
                                   const onSubmit = data =>{
                                        ...
                                        // })
                                        const url=`https://localhost:44352/api/Employee/add`;
                                        fetch(url, {
                                             method: 'POST',
                                             headers: {
                                                  'Accept': 'application/json',
                              ...
                              <div className="card mb-3">
                                   <div className="card-body">
                                        ...
                                        <form onSubmit={handleSubmit(onSubmitEdit)}>
                                             ...
                                             {errors.EId && <p className="text-danger">This field is required</p>}
                                             ...
                                             {errors.EName && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.EEmail && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.EPassword && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.EAddress && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.EPhone && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.EBasicSalary && <p className="text-danger">This field is required</p>}
                                        ...
                                        {errors.ESchedule && <p className="text-danger">This field is required</p>}

                                        <p className="text-center mt-2">
                                        <input className="btn btn-success my-2" type="submit" value="Edit Employee"/></p>
                                             ...
                                             {errors.bsalary && <p className="text-danger">This field is required</p>}
                                             ...
                                             {errors.schedule && <p className="text-danger">This field is required</p>}
                                   ...
                                   <div className="d-flex justify-content-center ">
                                        ...
                                        <p className="text-center mt-2">
                                             <input className="btn btn-success my-2" type="submit" value="Add Employee"/></p>
                                        </form>
