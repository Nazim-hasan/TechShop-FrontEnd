...
const MyProfile = () => {
     ...
     useEffect(() => {
          fetch('https://localhost:44352/api/Admin/get/1')
          .then(res => res.json())
          .then(result => setAdminDetails(result))
          }, [])
     return (
                                   ...
                                   <div className="card-body">
                                        <div className="d-flex flex-column align-items-center text-center">
                                             ...
                                             <div className="mt-3">
                                                  ...
                                                  <p className="text-muted font-size-sm">{adminDetails.AdminAddress}</p>
                                                  <button className="btn btn-primary"><a href={adminDetails.AdminEmail} target="_blank">Link</a></button>
                                                  <button className="btn btn-outline-primary"><a href={adminDetails.AdminEmail} target="_blank">Message</a></button>
                                             </div>
                                        </div>
                                   </div>
                              </div>
                              <div className="card mt-3">
                                   <ul className="list-group list-group-flush">
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                             ...
                                             <span className="text-secondary">https://{adminDetails.AdminName}.com</span>
                                        </li>
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                             ...
                                             <span className="text-secondary">{adminDetails.AdminName}</span>
                                        </li>
                                        <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                   ...
                                   <div className="card-body">
                                        ...
                                        <div className="row">
                                             <div className="col-sm-12">
                                                  <button to={`/dashboard/EditProfiles`} className="btn btn-info">Edit </button>
                                             </div>
                                        </div>
                                   </div>
                              </div>
